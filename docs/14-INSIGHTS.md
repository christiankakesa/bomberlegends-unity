...
| **Now** | Bomb drop audio · dash audio | Asset work, and one is the core verb (§4). **Deferred 2026-08-24**: the placeholders stay for now. The bomb drop was retuned to survive a phone speaker, and device testing then showed the real fault was the mix — the dash played 3.2× louder than the core verb, so every clip is now levelled to one measured loudness |
